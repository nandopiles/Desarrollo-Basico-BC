pageextension 50130 "LAB CustomerCard" extends "Customer Card"
{
    actions
    {
        addAfter("F&unctions")
        {
            action("LAB UpdateCreditLimit")
            {
    ...
    var
        AreYouSureQst: Label 'AreYouSureQst', Comment = 'Are you sure that you want to set the %1 to %2?';
        CreditLimitRoundedTxt: Label 'CreditLimitRoundedTxt', Comment = 'The credit limit was rounded to %1 to comply with company policies.';
        CreditLimitUpToDateTxt: Label 'CreditLimitUpToDateTxt', Comment = 'The credit limit is up to date.';
}